...
router.get("/root/signup", (req, res) => {
    res.send("signup Route working!!")
})
router.post("/api/root/signup",
...
router.put("/api/root/user/:emailId",
    async (req, res) => {
...
router.get("/api/root/userlist", async (req, res) => {
    try {
...
router.delete("/api/root/delete/:id", async (req, res) => {
    try {
